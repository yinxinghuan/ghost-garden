...
Ghost Garden 是一个 `simulation` 类型的移动端小游戏：幽灵庄园 — 养育你的小幽灵，探索3D低多边形墓园

## 2. Visual Design

- 整体布局：页面占用 100vw x 100vh，主体验居中，HUD 与操作区覆盖在游戏层上方，移动端以单手操作为优先。
- 背景与配色：主要颜色使用 #dead、rgba(255,255,255,0.07)、rgba(255,255,255,0.08)、rgba(255,255,255,0.06)、rgba(255,255,255,0.1)、#FFD700、#ecdeff、rgba(180,155,255,0.5)；高亮元素用于可点击目标、得分、结果或稀有状态。
- 字体：使用 'EB Garamond', 'Noto Serif SC', serif、inherit、'EB Garamond','Noto Serif SC',serif，按钮与状态文字保持 12-24 px 的可读范围。
...
- icon_candle.png：位图图片，用于角色、场景、封面、反馈或品牌视觉。
- icon_energy.png：位图图片，用于角色、场景、封面、反馈或品牌视觉。
- icon_moon.png：位图图片，用于角色、场景、封面、反馈或品牌视觉。
- poster.png：位图图片，用于角色、场景、封面、反馈或品牌视觉。
- icon_mood.png：位图图片，用于角色、场景、封面、反馈或品牌视觉。
- icon_hunger.png：位图图片，用于角色、场景、封面、反馈或品牌视觉。
