...
- 游戏：Ghost Garden
- 类型：simulation
- 简述：幽灵庄园 — 养育你的小幽灵，探索3D低多边形墓园
- 框架 / 语言 / 构建：TypeScript, Vite, Three.js
- 渲染方式：Canvas/WebGL
- 依赖摘录：three@0.169.0, vite@^5.1.0
- 平台元信息：meta.title=Ghost Garden；cover_url=/img/poster.png；category=simulation；uuid=54112bb3-9829-4ad1-a012-1c461c689058
